...
const Placeholder = "https://images.unsplash.com/photo-1549317661-bd32c8ce0be2?auto=format&fit=max&q=75&w=1080";
            ...
            <Container>
                <div>
                    <Button asChild className="mb-6 w-fit" size="sm" variant="outline">
                        <a className="not-prose" href="https://9d8.dev">
                            Lorem ipsum dolor sit amet <ArrowRight className="w-4 ml-2" />
                        </a>
                    </Button>
